package exercicios.desafio6.domain.dto;
...
public class SanduicheDto {
    ...
    public SanduicheDto(String chaveParticao, String chaveFiltragem, LocalDateTime dataAtualizacao, TipoDePao tipoDePao, String proteina, Integer alface, Integer tomate, Integer queijo, Integer picles) {
